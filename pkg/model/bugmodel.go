...
func (b *Bug) animateWings(dt float64) {
	...
	e2X, e2Y, e2Z := matrixToAngles(rotationMatrixRightWing.Mul4(mgl32.HomogRotate3D(mgl32.DegToRad(-b.currentWingRotationAngle), transformedForwardRightWing)).Mul4(rotationMatrixRightWing.Inv()))
