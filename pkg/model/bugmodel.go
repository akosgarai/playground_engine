...
func (b *Bug) animateWings(dt float64) {
	...
	eX, eY, eZ := matrixToAngles(mgl32.HomogRotate3D(mgl32.DegToRad(180-(b.maxWingRotationAngle-b.currentWingRotationAngle)), transformedForward).Mul4(rotationMatrix))
