...
func (b *Bug) animateWings(dt float64) {
	...
	rotatedOrigoBasedVector := mgl32.Vec3{1.0, cosDeg, -sinDeg}.Normalize()
	...
	b.meshes[4].SetPosition(mgl32.Vec3{b.wing1Position.X() * transformedVectorW1.X(), b.wing1Position.Y() * transformedVectorW1.Y(), b.wing1Position.Z() * transformedVectorW1.Z()})
