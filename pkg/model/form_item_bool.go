...
func NewFormItemBool(maxWidth, itemWidth, aspect float32, label, description string, mat *material.Material, position mgl32.Vec3, wrapper interfaces.GLWrapper) *FormItemBool {
	m := NewFormItemBase(maxWidth, itemWidth, aspect, label, description, mat, wrapper)
