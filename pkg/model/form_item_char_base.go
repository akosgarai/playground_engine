...
func NewFormItemCharBase(maxWidth, widthRatio, aspect float32, label, description string, inputMaxLen int, mat *material.Material, position mgl32.Vec3, wrapper interfaces.GLWrapper) *FormItemCharBase {
