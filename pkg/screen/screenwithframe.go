...
func (b *ScreenWithFrameBuilder) Build() *ScreenWithFrame {
	...
	frameModel.AddMesh(b.frameRectangle(b.frameWidth, b.frameLength*aspHeight, mgl32.Vec3{0.0, -0.55, ZFrame}))
	// left, right
	frameModel.AddMesh(b.frameRectangle(b.frameLength, (b.frameWidth*aspHeight - b.frameLength*2), mgl32.Vec3{-framePositionHorizontal, 0.0, ZFrame}))
