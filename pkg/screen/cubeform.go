...
func NewCubeFormScreenBuilder() *CubeFormScreenBuilder {
	return &CubeFormScreenBuilder{
		...
		leftScreenPosition:        mgl32.TransformCoordinate(mgl32.Vec3{2.0, 0, 0}, mgl32.HomogRotate3DZ(mgl32.DegToRad(60))),
		rightScreenPosition:       mgl32.TransformCoordinate(mgl32.Vec3{2.0, 0, 0}, mgl32.HomogRotate3DZ(mgl32.DegToRad(-60))),
